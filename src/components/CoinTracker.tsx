...
import { getTopCoins, searchCoins, Coin } from '@/services/coinService';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          {isLoadingTop
            ...
            : topMovers.map(coin => {
                ...
                return (
                  <div key={coin.id} className="bg-secondary/30 rounded-xl p-3 transition-transform hover:scale-[1.02] duration-200">
